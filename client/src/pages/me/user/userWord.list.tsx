...
@inject("wordStore")
@observer
export default class UserWordList extends Component<UserWordListProps, {}> {
    ...
    render() {
        ...
        return <View className="page" style={{ minHeight: windowHeight + "px" }}>
            <NavigationBar title="单词列表" hidePageTitle={true} backUrl="../me" openType={NavigatorOpenType.switchTab}></NavigationBar>
